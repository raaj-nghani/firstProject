...
object functions_withParameters extends App{
...
println(s"Total Cost of donut is $totalCostWithoutDiscount")
  println(s"total cost with coupne code is : $totalCostWithDiscount")
}
