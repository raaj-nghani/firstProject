...
object callByName extends App{
  ...
  val listOrders = List(("Glazed Donut", 5, 2.50), ("Vanilla Donut", 10, 3.50),("Water",2,1.5),("Guava",3,2.0))
  println("\nStep 2: How to define a function to loop through each tuple of the list")
